...
ActiveRecord::Schema.define(version: 2024_03_17_120904) do
  ...
  create_table "books_words", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.bigint "word_id", null: false
    t.bigint "book_id", null: false
    t.index ["book_id", "word_id"], name: "index_books_words_on_book_id_and_word_id"
  end
